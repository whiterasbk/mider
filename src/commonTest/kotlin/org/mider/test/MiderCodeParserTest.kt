...
class MiderCodeParserTest: RunningTestInMusicScore() {
    ...
    fun testFlatAndSharp() {
        ...
        assertTrue(list[3].cast<Note>().isNature)
    ...
    fun testAppoggiatura() {
        ...
        assertTrue(list[0].cast<Appoggiatura>().isFront)
        assertTrue(list[1].cast<Appoggiatura>().isFront)
        assertTrue(list[2].cast<Appoggiatura>().isFront)
        assertTrue(!list[3].cast<Appoggiatura>().isFront)
    ...
    fun testGlissando() {
        ...
        assertTrue(!list[0].cast<Glissando>().isWave)
        assertTrue(list[1].cast<Glissando>().isWave)
        assertTrue(!list[2].cast<Glissando>().isWave)
        assertTrue(!list[3].cast<Glissando>().isWave)
        assertTrue(!list[4].cast<Glissando>().isWave)
